...
- 🟠 **Deeper engine** — item stacking *buffs* (Berserker/Glass Cannon), active items as explicit combo steps, and fuller melee (the +50% weapon scaling, melee items, separate melee-resist channel). (On-hit procs are already in both burst and sustained DPS.)
