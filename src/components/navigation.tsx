...
const navItems = [
    { href: "/proving-ground", label: "Sandbox" },
];
...
export function Navigation() {
    ...
    return (
        <header style={{
            ...
            display: "flex", alignItems: "center", gap: 28, padding: "0 24px",
            ...
            <Link href="/" style={{ display: "flex", alignItems: "center", gap: 9, textDecoration: "none" }}>
                ...
                <span style={{ fontSize: 9, fontWeight: 600, letterSpacing: "0.24em", textTransform: "uppercase", color: "var(--text-dim)", marginTop: 2 }}>Industries</span>
            </Link>
